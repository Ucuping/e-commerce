...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('app-assets/vendors/css/forms/select/select2.css') }}">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('app-assets/vendors/daterangepicker/daterangepicker.css') }}" />
