                            ...
                            <div class="card ecommerce-card">
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <div class="item-name">
                                            <a href="app-ecommerce-details.html">
                                                <span>Adidas Neo Advantage Full White Origial Indonesia, Sepatu wanita putih
                                                    polos Sepatu couple putih</span>
                                            </a>
                                            <p class="item-company">By <span class="company-name">Adidas Sport</span>
                                            </p>
                                            <p class="stock-status-in">In Stock</p>
                                        </div>
                                        <div class="item-quantity">
